...
import requests
from homie_helpers import Homie, Node, FloatProperty, State, MqttSettings


class Gios:
    def __init__(self, config, mqtt_settings: MqttSettings):
        device_id = config['id']
        self.NORMS = {
        ...
        self.properties = {
            "C6H6": FloatProperty('c6h5', name="Benzen (C6H6)", unit="μg/m3",
                                  meta={'Measurement date': '0', 'Description': ''}),
            "CO": FloatProperty('co', name="Tlenek węgla (CO)", unit="μg/m3",
                                meta={'Measurement date': '1', 'Description': ''}),
            "NO2": FloatProperty('no2', name="Dwutlenek azotu (NO2)", unit="μg/m3",
                                 meta={'Measurement date': '2', 'Description': ''}),
            "PM10": FloatProperty('pm10', name="Pył zawieszony PM 10", unit="μg/m3",
                                  meta={'Measurement date': '3', 'Description': ''}),
            "PM2.5": FloatProperty('pm25', name="Pył zawieszony PM 2.5", unit="μg/m3",
                                   meta={'Measurement date': '4', 'Description': ''}),
        }
